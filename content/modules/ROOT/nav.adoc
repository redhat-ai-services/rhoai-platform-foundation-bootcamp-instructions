...
* Agentic AI with Llama Stack
    ** 30. xref:97_agentic_ai_llama_stack_introduction.adoc[Introduction & Setup]
    ** 30. xref:98_agentic_ai_llama_stack_notebook_agents.adoc[Agentic AI Agents with Llama Stack Clients]
    ** 31. xref:99_agentic_ai_llama_stack_playground.adoc.adoc[Llama Stack Playground]

* 40. xref:110_useful_tips.adoc[Useful Tips]
* 41. xref:111_syncing_fork.adoc[Syncing Forked Project]