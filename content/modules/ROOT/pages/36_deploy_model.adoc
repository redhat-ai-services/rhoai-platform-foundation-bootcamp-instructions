...
[%collapsible]
====
.tenants/parasol-insurance/multi-model-serving/overlays/parasol-insurance-dev/kustomization.yaml
...
+
.tenants/parasol-insurance/multi-model-serving/base/kustomization.yaml
...
[%collapsible]
====
.tenants/parasol-insurance/multi-model-serving/base/data-connection.yaml
...
+
.tenants/parasol-insurance/multi-model-serving/base/serving-runtime.yaml
...
+
.tenants/parasol-insurance/multi-model-serving/base/inference-service.yaml
