...
. Select **Practice / Enablement** for the **Activity** field and **Conduct internal training/enablement** for the Purpose field. For the **Region**, select **us-east-2**. If you are in EMEA or APAC, still choose **us-east-2**.
