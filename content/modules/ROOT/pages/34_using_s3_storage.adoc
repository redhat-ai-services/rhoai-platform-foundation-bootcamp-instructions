...
## Adding MinIO to the Cluster [DEPRECATED Needs refactoring for removal of tenants & ai-examples folders]
...
### Set up MinIO [DEPRECATED Needs refactoring for removal of tenants & ai-examples folders]
...
### Create a standard workbench [DEPRECATED Needs refactoring for removal of tenants & ai-examples folders]
