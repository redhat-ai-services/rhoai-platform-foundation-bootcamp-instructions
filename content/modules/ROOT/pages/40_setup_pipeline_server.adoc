# Setup the pipelines server [DEPRECATED Needs refactoring for removal of tenants & ai-examples folders]
...
## Setup the pipelines server (DSPA). [DEPRECATED Needs refactoring for removal of tenants & ai-examples folders]
